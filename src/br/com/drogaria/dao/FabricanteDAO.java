...
public class FabricanteDAO {
	...
	public static void main(String[] args) {
		 ...
		 * (SQLException e) { System.out.println("Dados não foram salvos!");
		 * e.printStackTrace();
		 * 
		 * }
		 * 
		 ...
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
		 * try { fdao.excluir(f1); System.out.println("Dados excluídos com sucesso!"); }
		 * catch (Exception e) { System.out.println("Dados não foram excluídos!");
		 * e.printStackTrace(); }
		 * 
		 ...
		 * (SQLException e) { System.out.println("Não foi possível alterar!");
		 * e.printStackTrace(); }
		 * 
		 * 
		 * Fabricante f1 = new Fabricante(); f1.setCodigo(1L);
